...
class Fleet_Embedding(nn.Module): 
    ...
    def __init__(self,fleet_feature_dim , hidden_dim  , heads = 4 ) :  
        ...
        self.Embedding = nn.Sequential( 
            ...
            nn.ReLU() ,
            Linear(hidden_dim, hidden_dim  , weight_initializer="kaiming_uniform") , 
            nn.LayerNorm(hidden_dim), 
            nn.ReLU() ,
        )        
    ...
    def forward(self,fleet_vector): 
        ...
        fleet_embedding = self.Self_attention1(fleet_embedding , fleet_embedding,fleet_embedding)
        fleet_embedding = self.Self_attention2( fleet_embedding , fleet_embedding,fleet_embedding)

        return fleet_embedding
