...
def Greedy(Agent ,config,BaseGraph = None , node_coordinate_table=None , return_looger=False  ): 
...
def PMPO(Agent , config ,  BaseGraph = None ,node_coordinate_table=None ,  return_looger=False   ):
...
def DE(Agent,config , BaseGraph=None , node_coordinate_table=None ,  return_looger=False  ): 
    simulator = simulator_maker(config ,PMPO=False, BaseGraph=BaseGraph,node_coordinate_table=node_coordinate_table)
    RoadNetwork , vehicle_pos , vehicle_capacity , final_change = simulator.reset()
...
def mix(Agent,config , BaseGraph=None , node_coordinate_table=None ,  return_looger=False  ): 
    simulator = simulator_maker(config ,PMPO=True, BaseGraph=BaseGraph,node_coordinate_table=node_coordinate_table)
    RoadNetwork , vehicle_pos , vehicle_capacity , final_change = simulator.reset()
...
def ORTools(Agent , config , BaseGraph=None,node_coordinate_table = None ,  return_looger=False  ) : 
    simulator = simulator_maker(config ,PMPO=False, BaseGraph=BaseGraph,node_coordinate_table=node_coordinate_table)
    terminate = False 
    RoadNetwork , vehicle_pos , vehicle_capacity , final_change = simulator.reset()
