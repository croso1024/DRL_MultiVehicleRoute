...
from net.ver7.Embedding import Node_Embedding , Fleet_Embedding , Vehicle_Embedding
from net.ver7.GraphNeuralNetwork import GraphNeuralNetwork
from net.ver7.Attention import Attention_Block
from net.ver7.PermuteLayer import Permute
...
class PolicyNetwork(nn.Module): 
    ...
    def __init__(self , node_feature_dim , fleet_feature_dim , vehicle_feature_dim , hidden_dim  ,edge_dim=1, 
        ...
        self.Pointer = PointerNetwork(hidden_dim=hidden_dim,heads=heads , clip_coe=clip_coe , temp=temp)
