...
from net.ver1.Embedding import Node_Embedding , Fleet_Embedding , Vehicle_Embedding
from net.ver1.GraphNeuralNetwork import GraphNeuralNetwork
...
class PointerNetwork(nn.Module):
    ...
    def forward(self,Graph_state , Fleet_state , Vehicle_state , batch_ptr , mask): 
        ...
        # probablity_dist = batch x node_num x 3 
        probablity_dist = torch.bmm(Graph_state,Query.permute(0,2,1)) / sqrt(self.hidden_dim) 
        #probablity_dist = self.point(probablity_dist)
